...
По истечению 15 минут нужно перезайти в систему (залогиниться заново)
...
Vue.js
src/
├── api/ # API клиент для работы с бекендом
├── stores/ # Pinia хранилища (auth)
...
- JWT токены с реалистичными сроками жизни (15 минут для access, 7 дней для refresh)
...
- Истечение токенов (ждать 15 минут или модифицировать mock-сервер)
